...
?>
                            ...
                            <div class="col-lg-4 col-md-6 special-grid ">
                                <form method="post" action="menu_insert.php?action=add&id=<?php echo $row["id"];?>"/>
					<div class="gallery-single fix">
                                            <img src="images/<?php echo $row['p_pic']; ?>" class="img-fluid" alt="Image" />
						<div class="why-text" >
                                                        <h4>Main</h4>
							<p><?php echo $row['Name']; ?></p>
                                                        <h5><?php echo $row['Cost']; ?> Baht </h5><br>
							...
							<input type="submit" name="Add" class="btn-3" value="Add to Cart" /> &nbsp;
						</div>
					</div>
                                    </form>
				</div>
