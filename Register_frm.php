	...
	<div class="customer-Register-box" style="background-color:#f7ce48;">
      ...
      <div class="col-lg-12">
        <div class="heading-title text-center"><br><br>
          <center>
            <img src="images/LOGO.png" alt="" width="300" height="200"/><br><br>
             

           <h2 class="title">REGISTER</h2> <!-- ส่วน Register -->
         ...
         <div   style=" padding: 50px ; margin: 10px ; width: 678.33px ;background-color:#006c31">
          	...
          	<div class="row">
              <div class="col-md-0 offset-xl-1">
             <img src="images/home_icon.png" alt="" width="30" height="30"/>&nbsp;>&nbsp;
                <input type="text" name ="Location" placeholder="Location" SIZE="55" required autofocus/></div></div>
              </div><br>
          ...
          <div class="col-md-0 offset-xl-1">
              ...
              <a href="Login_frm.php"> >>> Login <<< </a></p>
              </center>
      </div>
    </div>
	  </div>
